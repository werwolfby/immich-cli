...
This CLI has been deprecated in favor of the [new Immich CLI](https://immich.app/docs/features/command-line-interface). This repository is kept for historical purposes only.
